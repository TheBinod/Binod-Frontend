...
<div className="typewriter ">
    ...
    <div className='first max-sm:w-full flex  flex-col max-sm:gap-[-6px]  justify-center items-center w-1/3 text-white'>
            ...
            <button className=' border-2 text-yellow-500 max-sm:mt-1 mt-7  border-yellow-500 rounded-sm p-[3px] max-sm:p-[2px] max-sm:text-sm'>Contact Me</button>
    </div>
    ...
    <button className='text-yellow-500 text-sm mt-5 max-sm:mt-1 underline'>See More ↓</button>
